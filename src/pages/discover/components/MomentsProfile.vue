<template>
  <div class="profile__wrapper">
    <div class="profile__top-wrapper" :style="{ height: topHeight }" @click="coverDidClick">
    ...
    <div class="profile__bottom-wrapper" :style="{ height: bottomHeight }">
      <div class="bottom-wrapper__message" @click.stop="messageDidRead" v-if="unreadCount">
...
.profile__top-wrapper {
  width: 100%;
  background: url('@/assets/moments/kris.png') no-repeat 0 0;
